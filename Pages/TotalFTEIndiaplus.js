...
class TotalFTEIndiaplus {
    constructor(page){
        ...
        this.TotalFTEIndiaplusLocator={
            ...
            ftecost2: "//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[7]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]"
        };
    ...
    async TotalFTEIndiaplus(){
        ...
        await frames[1].locator(this.TotalFTEIndiaplusLocator.pl).click();
        await this.page.waitForTimeout(2000);

        await frames[1].locator(this.TotalFTEIndiaplusLocator.indiaplus).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE1 = await frames[1].locator(this.TotalFTEIndiaplusLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.TotalFTEIndiaplusLocator.delta).click();
        await this.page.waitForTimeout(2000);

        await frames[1].locator(this.TotalFTEIndiaplusLocator.iplus).click();
        await this.page.waitForTimeout(2000);
        
        const TotalFTE2 = await frames[1].locator(this.TotalFTEIndiaplusLocator.ftecost2).textContent();
        console.log(" TotalFTE 2 " + TotalFTE2);
        valueList.push(TotalFTE2);

        console.log("valueList: ", valueList);
        let normalizedValues = valueList[0].replace(/[^0-9]/g, '');
...
module.exports = { TotalFTEIndiaplus }; 