...
class EmployeeUs {
    constructor(page){
        ...
        this.EmployeeUsLocator={
            employee:"(//span[contains(text(), 'Employee')])[2]",
            kpicard:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container-group[6]/transform/div/div[2]/visual-container[2]/transform/div/div[3]/div/div/visual-modern/div",
            Monthhc:"((//*[local-name()='svg' and @class='svgScrollable'])[1]//*[name()='text' and @class='label'])[2]"
        }
    ...
    async EmployeeUs(){
      ...
      await frames[0].locator(this.EmployeeUsLocator.employee).click();
        await this.page.waitForTimeout(2000);

        


        const Function1 = await frames[1].locator(this.EmployeeUsLocator.kpicard).textContent();
        console.log(" KPI Card " + Function1);
        ...
        const Monthly = await frames[1].locator(this.EmployeeUsLocator.Monthhc).textContent();
        console.log(" Monthly trend" + Monthly);
        valueList.push(Monthly);
