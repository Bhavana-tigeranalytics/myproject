...
class TotalNONFTEUS{
    constructor(page){
        ...
        this.TotalNONFTEUSLocator={
            ...
            ftecost:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[8]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[27]/div[2]/div/div[4]/div[1]",
            delta:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[3]",
            ftecost2:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[8]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[26]/div[2]/div/div[2]/div[1]"
        }
    ...
    async TotalNONFTEUS(){
        ...
        await frames[1].locator(this.TotalNONFTEUSLocator.pl).click();
        await this.page.waitForTimeout(2000);
        
        const TotalFTE1 = await frames[1].locator(this.TotalNONFTEUSLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.TotalNONFTEUSLocator.delta).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE2 = await frames[1].locator(this.TotalNONFTEUSLocator.ftecost2).textContent();
