...
class TotalFTEDelivery {
    constructor(page){
        ...
        this.TotalFTEDeliveryLocator={
            ...
            ftecost:"(//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[7]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[10]/div[2]/div/div[6])",
            ...
            ftecost2:"(//div[contains(@class, 'pivotTableCellWrap') and contains(@class, 'cell-interactive') and contains(@class, 'tablixAlignRight') and contains(@class, 'main-cell')])[26]"
        }
    ...
    async TotalFTEDelivery(){
      ...
      await frames[1].locator(this.TotalFTEDeliveryLocator.headcount).click();
        await this.page.waitForTimeout(2000);

         let TotalFTE1 = await frames[1].locator(this.TotalFTEDeliveryLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        ...
        const TotalFTE2 = await frames[1].locator(this.TotalFTEDeliveryLocator.ftecost2).textContent();
...
module.exports = { TotalFTEDelivery }; 