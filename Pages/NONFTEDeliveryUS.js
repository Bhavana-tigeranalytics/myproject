...
class NONFTEDeliveryUS {
    constructor(page){
        ...
        this.NONFTEDeliveryUSLocator={
            ...
            ftecost:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[8]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[14]/div[2]/div/div[4]",
            ...
            ftecost2:"(//div[contains(@class, 'pivotTableCellWrap') and contains(@class, 'cell-interactive') and contains(@class, 'tablixAlignRight') and contains(@class, 'main-cell')])[35]",
        }
    ...
    async NONFTEDeliveryUS(){
        ...
        await frames[1].locator(this.NONFTEDeliveryUSLocator.headcount).click();
        await this.page.waitForTimeout(2000);
        

        const TotalFTE1 = await frames[1].locator(this.NONFTEDeliveryUSLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.NONFTEDeliveryUSLocator.delta).click();
        await this.page.waitForTimeout(2000);
        
        await frames[1].locator(this.NONFTEDeliveryUSLocator.toggle).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE2 = await frames[1].locator(this.NONFTEDeliveryUSLocator.ftecost2).textContent();
...
module.exports = { NONFTEDeliveryUS }; 