...
class TotalFTEDeliveryUS {
    constructor(page){
        ...
        this.locators = {
            ...
            overview: "(//span[contains(text(), '2 more')])",
        ...
        this.TotalFTEDeliveryUSLocator={
            more:"(//span[contains(text(), '2 more')])",
            uspnl:"(//span[contains(text(), 'US+PNL')])",
            headcount:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[2]",
            ftecost:"(//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[8]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[9]/div[2]/div/div[4])",
            delta:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[4]",
            toggle:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[5]",
            ftecost2:"(//div[contains(@class, 'pivotTableCellWrap') and contains(@class, 'cell-interactive') and contains(@class, 'tablixAlignRight') and contains(@class, 'main-cell')])[23]",
        }
    ...
    async TotalFTEDeliveryUS(){
        ...
        await frames[1].locator(this.TotalFTEDeliveryUSLocator.headcount).click();
        await this.page.waitForTimeout(2000);
        

        const TotalFTE1 = await frames[1].locator(this.TotalFTEDeliveryUSLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.TotalFTEDeliveryUSLocator.delta).click();
        await this.page.waitForTimeout(2000);
        
        await frames[1].locator(this.TotalFTEDeliveryUSLocator.toggle).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE2 = await frames[1].locator(this.TotalFTEDeliveryUSLocator.ftecost2).textContent();
...
module.exports = { TotalFTEDeliveryUS }; 