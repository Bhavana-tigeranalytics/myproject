...
class TotalNONFTEDelivery {
    constructor(page){
        ...
        this.TotalNONFTEDeliveryLocator={
            indiapnl:"(//span[contains(text(), 'INDIA PNL')])",
            headcount:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[2]",
            ftecost:"(//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[7]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[26]/div[2]/div/div[6])",
            ...
            ftecost2:"(//div[contains(@class, 'pivotTableCellWrap') and contains(@class, 'cell-interactive') and contains(@class, 'tablixAlignRight') and contains(@class, 'main-cell')])[71]"
        }
    ...
    async TotalNONFTEDelivery(){
        ...
        await frames[1].locator(this.TotalNONFTEDeliveryLocator.headcount).click();
        await this.page.waitForTimeout(2000);
        

        const TotalFTE1 = await frames[1].locator(this.TotalNONFTEDeliveryLocator.ftecost).textContent();
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.TotalNONFTEDeliveryLocator.delta).click();
        await this.page.waitForTimeout(2000);
        
        await frames[1].locator(this.TotalNONFTEDeliveryLocator.toggle).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE2 = await frames[1].locator(this.TotalNONFTEDeliveryLocator.ftecost2).textContent();
...
module.exports = { TotalNONFTEDelivery }; 