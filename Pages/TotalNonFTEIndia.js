...
class TotalNonFTEIndia {
    constructor(page){
        ...
        this.TotalNonFTEIndiaLocator={
            indiapnl:"(//span[contains(text(), 'INDIA PNL')])",
            pl:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[1]",
            ftecost:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[7]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[20]/div[2]/div/div[6]/div[1]",
            delta:"(//*[local-name()='div' and @aria-label='Page navigation . Click here to follow link'])[3]",
            ftecost2:"//*[@id='pvExplorationHost']/div/div/exploration/div/explore-canvas/div/div[2]/div/div[2]/div[2]/visual-container-repeat/visual-container[7]/transform/div/div[3]/div/div/visual-modern/div/div/div[2]/div[1]/div[2]/div/div[18]/div[2]/div/div[2]/div[1]"
        }
    ...
    async TotalNonFTEIndia(){
        ...
        await frames[1].locator(this.TotalNonFTEIndiaLocator.pl).click();
        await this.page.waitForTimeout(2000);

        const TotalFTE1 = await frames[1].locator(this.TotalNonFTEIndiaLocator.ftecost). textContent();                                                                                                                                                                                                                                                                                              
        console.log(" TotalFTE 1 " + TotalFTE1);
        valueList.push(TotalFTE1);

        await frames[1].locator(this.TotalNonFTEIndiaLocator.delta).click();
        await this.page.waitForTimeout(2000);
        
        const TotalFTE2 = await frames[1].locator(this.TotalNonFTEIndiaLocator.ftecost2).textContent();
...
module.exports = { TotalNonFTEIndia }; 